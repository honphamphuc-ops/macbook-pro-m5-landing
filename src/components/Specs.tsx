...
export function Specs() {
  return (
    <section id="specs" className="bg-background-alt px-6 py-12 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 overflow-hidden rounded-[1.5rem] border border-border-custom bg-background shadow-sm">
